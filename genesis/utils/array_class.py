...
class ErrorCode(IntEnum):
    ...
    OVERFLOW_VBD_CONTACT_CELL = 0b00000000000000000000000010000000
    OVERFLOW_VBD_CONTACT_PAIRS = 0b00000000000000000000000100000000
    OVERFLOW_VBD_CONTACT_SWEEP = 0b00000000000000000000001000000000
    INVALID_VBD_CONTACT_NAN = 0b00000000000000000000010000000000
    VBD_CONTACT_CROSSING = 0b00000000000000000000100000000000
    VBD_CONTACT_MOTION_BOUND = 0b00000000000000000001000000000000
    VBD_TISSUE_PERSISTENT_INVERSION = 0b00000000000000000010000000000000
